...
async def get_linkedin_data(req: ActivityRequest):
    ...
    try:
        ...
        if req.activity_comments == "yes":
            response_data["comments"] = linkedin.extract_comment_details(req.username,req.post_limit,req.comment_limit,req.reaction_limit,job_id)

        if req.activity_reactions == "yes":
            response_data["reactions"] = linkedin.extract_likes_details(req.username,req.post_limit,req.comment_limit,req.reaction_limit ,job_id)
